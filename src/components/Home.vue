                    ...
                    <div class="row mt-4">
                        <div class="col-lg-4 col-md-6 mb-3">
                            <div class="card h-100 border-light shadow">
                                ...
                                <div class="card-body">
                                    <p class="card-text"><strong>Готовая корпоративная библиотека</strong> для обучения и развития сотрудников: более 170 часов видео-курсов по управлению на вашем корпоративном сервере.</p>
